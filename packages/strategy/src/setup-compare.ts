 ...
 *
 * The *what changed* half is the read-only `.svm` delta (`diffSetups`, T9.1); this is the *did-it-help*
 * half, judged from the front-vs-rear tyre-temp gap (smaller gap = closer to balanced). Pure/
